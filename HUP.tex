...
das vogais de acordo com a nasalidade --- indicada por um til --- e o tom --- indicado por um acento agudo ou grave.
...
glotal.} Entre elas, dezesseis são consoantes e nove são vogais. Há ainda onze consoantes
laringalizadas: \textit{b'}, \textit{d'}, \textit{r'}, \textit{j'}, \textit{g'}, \textit{m'}, \textit{n'}, \textit{w'}, \textit{y'}, \textit{s'}, \textit{k'}.\looseness=-1
